...
raiz_local=time(NULL)+N*rango_processo;
...
//Para que el rand() pueda leer una seria de numeros differentes de los otros processos (N*rango_processo) y de
//cada nueva llamada del ejecutable (time(NULL)) damos raiz=time(NULL)+N*rango_processo.Con eso aproximamos bien la independancia de
//las simulaciones entre los processos y entre cada llamda del ejecutable.
