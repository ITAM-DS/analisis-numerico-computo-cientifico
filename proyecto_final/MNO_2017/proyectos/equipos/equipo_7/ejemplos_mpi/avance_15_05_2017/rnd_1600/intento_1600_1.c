...
// Compile
// mpicc -g -Wall -o intento_1600_1.out intento_1600_1.c

// Execute
// mpiexec -n 1 intento_1600_1.out t 1600000 > time_1600_1.txt

// Distributed execute
// mpirun --prefix /opt/openmpi-2.0.2/ -n 2 -H master,nodo1 intento_1600_1.out t 1600000 > time_cluster_1600_2
// mpirun --prefix /opt/openmpi-2.0.2/ -n 4 -H master,nodo1,nodo2,nodo3 intento_1600_1.out t 1600000 > time_cluster_1600_4
// mpirun --prefix /opt/openmpi-2.0.2/ -n 8 -H master,nodo1,nodo2,nodo3,nodo4,nodo5,nodo6,nodo7 intento_1600_1.out t 1600000 > time_cluster_1600_8
