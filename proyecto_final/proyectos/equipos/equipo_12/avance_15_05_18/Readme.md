...
El códidigo de referencia que encontramos utiliza CUDA por lo que se realizaron los ejercicios de clase de CUDA en AWS para familiarizarse con el ambiente y correr el algoritmo que encontramos en este ambiente.
