...
int main(int argc, char const *argv[]) {
  ...
  // Definición de estructuras que almacenarán los datos
    ...
    arreglo_1d_T y, y_v, b, g, y_b, mt, vt, tmp1, tmp2;
    ...
    // Se reestablece el valor para y al principio de cada iteración
        ...
        for(int i =0; i< N; i++){
            entrada_vector(b,i) = entrada_vector(b,i) - lr*entrada_vector(mt,i)/(1-pow(beta_adam_1,it)*(sqrt(entrada_vector(vt,i)/(1-pow(beta_adam_2,it)))+epsilon));
        }
    }
