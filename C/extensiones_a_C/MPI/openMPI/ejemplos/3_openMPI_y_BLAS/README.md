...
En las carpetas para los diferentes niveles de BLAS: [level1](level1), [level2](level2), level3 se tienen códigos que utilizan los archivos `definiciones.h` y `funciones.c` siguiente:
