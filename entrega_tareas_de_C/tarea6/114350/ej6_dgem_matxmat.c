...
#define A_matriz "A_1.txt" //de tamaño MxK  igual usé la matriz propuesta por mi del 2do ejercicio
#define B_matriz "B_1.txt" //de tamaño KxN  mantendré el mismo nombre del archivo pero con valores propuestos por mi
