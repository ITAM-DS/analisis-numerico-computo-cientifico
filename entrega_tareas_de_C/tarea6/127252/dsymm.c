/* Para simplificar el codigo asumimos Left y Upper*/
/* Bastaría con permitir ingresar estos parametros en la terminal para hacerlo más general*/


#include<stdio.h>
#include<stdlib.h>
#include"definiciones.h"
#define A_matriz "A.txt" //de tamaño M*M
...
int main(int argc, char *argv[]){
  ...
  columnas(A) =M;
	...
	printf("matriz R:\n");
	dsymm_("L", "U", &M, &N, &ALPHA, entradas(A), &M, entradas(B), &M, &BETA, entradas(C), &N);
	imprime_matriz(C);
