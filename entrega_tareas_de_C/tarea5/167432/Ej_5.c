//Usamos el programa de dot_product como base y ajustamos el parámetro alpha que multiplica a la matriz.
#include<stdio.h>
#include<stdlib.h>
#include"definiciones.h"
#define v1_vector "v1.txt" //de tamaño Nx1
#define v2_vector "v2.txt" //de tamaño Nx1
extern double daxpy_(int *n, double *a, double *A, int *incA, double *B, int *incB);
