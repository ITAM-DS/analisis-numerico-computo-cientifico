...
Con el fin de aclarar los avances que se han realizado hasta el momento se modifica tanto el READme como el [avance_24_04_2017](https://github.com/ITAM-DS/analisis-numerico-computo-cientifico/tree/master/MNO/proyecto_final/MNO_2017/proyectos/equipos/equipo_4/avance_24_04_2017) bajo el apartado **Corrección**.
...
Liz encontró en internet la [implementación de Sai Krishna](http://cs.indstate.edu/~syedugani/number.html) que podriamos utilizar de igual manera para la comprobación de resultados. Realizamos la revisión de estos resultados y parece ser que la herramienta funciona. 
