...
extern double (*mall_matriz1)[], (*mall_matriz2)[], (*mall_matriz_resultado)[];
int main(void)
{
    char TRANSA, TRANSB;
    int M = NUM_REN_MAT1;
    ...
    imprime_matrices();
    dgemm_(&TRANSA, &TRANSB, &N, &M, &K, &ALPHA, *mall_matriz2, &N, *mall_matriz1, &K, &BETA, *mall_matriz_resultado, &N);
