...
double  **mat_1 = malloc(NUM_REN_MAT1 * sizeof(double*));
size_t i;
for (i = 0; i < NUM_REN_MAT1; i ++)
	mat_1[i] = malloc(NUM_COL_MAT1 * sizeof(double));
mat_1[0][0]= 0;
mat_1[0][1]=1.5;
mat_1[1][0]=4;
mat_1[1][1]=-5;
mat_1[2][0]=-1;
mat_1[2][1]=2.5;
double **mat_2 = malloc(NUM_REN_MAT2 * sizeof(double*));
for (i = 0; i< NUM_REN_MAT2; i ++)
	mat_2[i] = malloc(NUM_COL_MAT2 * sizeof(double));
mat_2[0][0]=1;
mat_2[0][1]=0;
mat_2[0][2]=0;
mat_2[1][0]=0;
