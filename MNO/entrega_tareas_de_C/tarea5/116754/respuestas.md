...
## d) Compara tu resultado usando la subrutina de Fortran ```dgemm```.
Obtenemos el mismo resultado pero sin necesidad de definir nosotros la operación de multiplicación de matrices.
