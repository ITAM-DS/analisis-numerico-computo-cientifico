...
# JUPYTERLAB SERVICE IS USING DOCKER IMAGE FROM NEXT [Dockerfile](https://github.com/palmoreck/dockerfiles/blob/master/jupyterlab/kale/general/certs/0.6.1/Dockerfile)
